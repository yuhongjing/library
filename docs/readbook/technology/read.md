...
* [《You-Dont-Know-JS》](./你不知道的javascript.md)
...
* [《Node.js 来一打C++扩展》](./NodeJs来一打C加加扩展.md)

## 前端生态
* [《锋利的jQuery》](./锋利的jquery.md)
* [《深入浅出Webpack》](./深入浅出Webpack.md)
* [《Vue.js实战》](./vuejs实战.md)
...
## 代码质量
* [《201 principles of software development》](./201principlesofsoftwaredevelopment.md)
* [《编写可读写代码的艺术》](./编写可读写代码的艺术.md)
* [《代码大全》](./代码大全.md)
* [《代码整洁之道》](./代码整洁之道.md)

## C语言
* [《C Primer Plus》](./CPrimerPlus.md)

## PHP
* [《PHP核心技术与最佳实践》](./php核心技术与最佳实践.md)

## JAVA
* [《疯狂Java讲义》](./疯狂Java讲义.md)

## 内功
* [《编码隐匿在计算机硬件背后的语言》](./编码隐匿在计算机硬件背后的语言.md)
* [《剑指offer》](./剑指offer.md)
