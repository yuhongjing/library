module.exports = async function build (sourceDir, cliOptions = {}) {
    ...
    const getWordNumber = require('../workCount');
    ...
    function replaceAmountWordNumber() {
        const wordNumbers = getWordNumber();
        ...
        const newBuffer = buffer.replace(reg, `手册小站目前有${wordNumbers}字`);
